...
namespace MarutiTrainingPortal.Services
{
    public interface ICourseService
    {
        ...
        AICourse? GetCourse(string courseCode);
        List<AICourse> GetCoursesByLevel(string level);
        List<AICourse> GetFreeCourses();
        List<AICourse> GetPremiumCourses();
        LearningPath? GetLearningPath(string pathId);
        List<AICourse> GetCoursesForRole(string role);
    ...
    public class CourseService : ICourseService
    {
        ...
        public AICourse? GetCourse(string courseCode)
        {
        ...
        public List<AICourse> GetCoursesByLevel(string level)
        {
        ...
        public List<AICourse> GetFreeCourses()
        {
            return _catalog.Courses.Where(c => c.IsFree).ToList();
        }

        public List<AICourse> GetPremiumCourses()
        {
        ...
        public List<AICourse> GetCoursesForRole(string role)
        {
            return _catalog.Courses
