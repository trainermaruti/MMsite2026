...
namespace SkillTechNavigator.Controllers
{
    [ApiController]
    ...
    public class ChatController : ControllerBase
    {
        ...
        public ChatController(IGeminiService geminiService, ICourseService courseService, ILeadService leadService, ILogger<ChatController> logger)
        {
