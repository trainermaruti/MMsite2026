        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalTrainingsDone = table.Column<int>(type: "INTEGER", nullable: false),
                    ...
                    CertificationsAndAchievements = table.Column<string>(type: "TEXT", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegisteredParticipants = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "8e445865-a24d-4543-a6c6-9443d048cdb9", 0, "36d48de0-c394-46d6-96fe-b0886018a0c3", "admin@marutitraining.com", true, false, null, "ADMIN@MARUTITRAINING.COM", "ADMIN@MARUTITRAINING.COM", "AQAAAAIAAYagAAAAEDS8MxcUhMEjGBEKKN8t+IloLAJX+D8PZ/ExlGC50jUDp6zCO6/V+cDz22+APviyaQ==", null, false, "778174dc-4e9d-4e66-93a4-cfc69ee36400", false, "admin@marutitraining.com" });

            migrationBuilder.InsertData(
                table: "Profiles",
                columns: new[] { "Id", "Bio", "CertificationsAndAchievements", "CreatedDate", "Email", "Expertise", "FullName", "GitHubUrl", "LinkedInUrl", "PhoneNumber", "ProfileImageUrl", "Title", "TotalStudents", "TotalTrainingsDone", "TwitterUrl", "UpdatedDate", "WhatsAppNumber" },
                values: new object[] { 1, "Passionate corporate trainer with expertise in Azure Cloud Services and AI technologies. Dedicated to empowering IT professionals with cutting-edge skills.", "Azure Certified Trainer, AI Specialist, AWS Certified Solutions Architect", new DateTime(2025, 11, 30, 8, 54, 37, 36, DateTimeKind.Utc).AddTicks(8124), "maruti@example.com", "Azure Cloud, AI, Machine Learning, DevOps, Cloud Architecture", "Maruti Makwana", "https://github.com/maruti", "https://linkedin.com/in/maruti", "+91-XXXXXXXXXX", "/images/profile-placeholder.jpg", "Corporate Trainer - Azure Cloud & AI", 2000, 50, "https://twitter.com/maruti", new DateTime(2025, 11, 30, 8, 54, 37, 36, DateTimeKind.Utc).AddTicks(8126), "+91-XXXXXXXXXX" });
